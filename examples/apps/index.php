...
if ($client->getAccessToken()) {
  ...
  $req = new HttpRequest("https://apps-apis.google.com/a/feeds/$domain/$user/2.0");
  ...
  $domain = "example.com";
  $user = rawurlencode("user@domain.com");
  $req = new HttpRequest("https://apps-apis.google.com/a/feeds/alias/2.0/$domain?userEmail=$user");
  $resp = $client::getIo()->authenticatedRequest($req);
  ...
  $domain = "example.com";
  $user = rawurlencode("user@domain.com");
  $req = new HttpRequest("https://apps-apis.google.com/a/feeds/alias/2.0/$domain/$user", 'DELETE');
  $resp = $client::getIo()->authenticatedRequest($req);
  print "<h1>Deleting a User Alias from a Domain</h1>: <pre>" . $resp->getResponseBody() . "</pre>";


  // Retrieving List of 100 Nicknames
  $req = new HttpRequest("https://apps-apis.google.com/a/feeds/domain/nickname/2.0");
  $resp = $client::getIo()->authenticatedRequest($req);
